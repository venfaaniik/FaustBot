    ...
    if ("tent") in content:
        ...
        if ("wank") in content:
            ...
            if percent == 0:
                ...
                await msg.channel.send("Tell me, why do you keep saying that word? I feel like it's in everywhere: In the wind that carries your awful smell, in the ground that eventually shall take your cold body, even in the fire that shall soon burn you; as soon as I finish this incantation. Would you be kind and stop using this word 'Tent'. I do not wish to hear it anymore from that filthy mouth of yours. The next time I hear it, I'll remove your... speaking priviledges.")
                return 
            else:
                possible_responses = [
...
async def clairvoyance(ctx):
    possible_responses = [
            ...
            'Oh yes.',
            'Certainly.',
            'The Eternal Fire is with you.',
            'The vision is blurry.',
            'Something is interfering with my vision.',
            'Without a doubt.',
            'As I see it, yes.',
            'I am sure of that.'
            ]
